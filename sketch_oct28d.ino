...
void setup() {
  Serial.begin(115200);
  SerialBT.begin("bluetoothTest BT");
...
void Charging() {
  ...
  cableStepper.step(stepsPerRevolution);
  }*/
  ...
  for (;;) {
    ...
    if(AmpsRMS <= 0.45){ //너무 높게 잡은듯.. //0.25
...
//현재는 좌석사이 거리 500으로 설정했지만 실제 주차장에 설치후 좌표값 재설정할것
